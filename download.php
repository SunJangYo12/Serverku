...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalabe=no"/>
    ...
    elseif ($aksi[0] == 'videoview') {
        ...
        echo '
            ...
            &nbsp&nbsp<input type=submit value=Favorite id=nothing onclick=favorite(this.id) />
            ...
            function rincian(name) {
                ...
                window.open(
                    "ajax-server.php?idexl=vidinfomedia:"+encname,
                    "_blank"
                );
            ...
            function favorite(name) {
                ...
                window.open(
                    "ajax-server.php?idexl=vidfavorite:"+encname,
                    "_blank"
                );
