...
border-radius:5px;
        ...
        <font color=yellow><h1>Sucess adding video: </h1></font>
        ';

        echo($name);

        if (!file_exists('vidfavorite'))
            mkdir('vidfavorite', 0777, true);

        echo($name);

        copy($path, "vidfavorite/".$name);        
    }
